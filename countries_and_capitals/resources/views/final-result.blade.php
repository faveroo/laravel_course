<x-main-layout title="Final Result">
    ...
    <div class="row fs-1">
        ...
        <div class="col {{ $percent < 50 ? 'text-danger' : 'text-success' }}">{{ $percent }}%</div>
    </div>

    <div class="text-center mt-5">
        <a href="{{ route('game.start') }}" class="btn btn-primary mt-3 px-5">VOLTAR AO INÍCIO</a>
    </div>
</x-main-layout>